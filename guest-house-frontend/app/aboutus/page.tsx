...
import airstraLogo from '~/public/images/about-us/airstra2.png'
import bLogo from '~/public/images/about-us/b2.png'
import bartaLogo from '~/public/images/about-us/barta2.png'
import brandBazar from '~/public/images/about-us/brand-bazar.png'
import bsLogo from '~/public/images/about-us/business-standard2.png'
import sahadatAvatar from '~/public/images/about-us/dr-sahadat.jpeg'
import rababAvatar from '~/public/images/about-us/rahab-rana.jpeg'
import tawratAvatar from '~/public/images/about-us/tawrat.jpg'
...
export default function About() {
  ...
  return (
    <>
      ...
      <Container>
        <main className='py-10 md:py-20' data-page='about-us'>
...
const TopBrandingBanner = () => {
  return(
    <section className='pt-20 pb-10 md:pt-0 container'>
      <div className='flex flex-col justify-center text-center'>
        <h2 className='text-3xl font-semibold'>Why Choose Us?</h2>
        <p className='text-grayText text-sm mt-3 mx-auto md:w-[500px]'>Unlock a world of unique stays. Ditch the ordinary hotel experience 
        and discover the comfort and character of a Stayverz vacation rental.</p>
      </div>
      {/* branding with icons */}
      <div className='mt-10 flex flex-col gap-10 md:flex-row md:justify-between md:gap-40'>
        <div className='flex flex-col items-center gap-4 justify-start'>
          ...
          <div className='text-center flex flex-col gap-5'>
            <h4 className='text-lg font-semibold'>Price Promise</h4>
            <p className='text-sm text-grayText'>Find the perfect place at a great price as we commit to offering competitive rates on our platform</p>
          </div>
        </div>
        ...
        <div className='flex flex-col items-center gap-4 justify-start'>
          ...
          <div className='text-center flex flex-col gap-5'>
            <h4 className='text-lg font-semibold'>Effortless Booking</h4>
            <p className='text-sm text-grayText'>Book in clicks. Our user-friendly platform lets you reserve your stay in minutes</p>
          </div>
        </div>
        ...
        <div className='flex flex-col items-center gap-4 justify-start'>
          ...
          <div className='text-center flex flex-col gap-5'>
            <h4 className='text-lg font-semibold'>Professional Care</h4>
            <p className='text-sm text-grayText'>Our friendly booking experts are happy to answer any questions you have</p>
          </div>
        </div>
      </div>
    </section>
...
const AboutStayverz = () => {
  return(
    <section className='grid grid-cols-1 lg:grid-cols-2 my-10 gap-10 md:flex-row md:justify-between md:items-center md:my-20 container'>
      <div className='w-full'>
        <h2 className='text-3xl font-semibold uppercase'>About Stayverz</h2>
        <p className='mt-5 text-sm md:text-base'>
          <b>Who we are?</b><br/>
          Stayverz<i>(TRAD/DNCC/042928/2023)</i> is your gateway to unique short-term rentals in Bangladesh. We connect guests with hosts who offer comfortable homes, allowing them to experience destinations like locals. And bringing an opportunity for the hosts to earn 2/3 times more than their usual monthly rental income.<br/><br/>

          <b>What do we do?</b><br/>
          We offer a curated selection of rentals, from cozy apartments to luxurious places, ensuring a perfect fit for everyone. Our user-friendly platform makes booking a smooth process, and our friendly customer service team is always available to assist you.<br/><br/>

          <b>Ready to explore?</b><br/>
          Book your Stayverz rental today and create unforgettable memories!<br/>
        </p>
      </div>
      <div className='w-full h-auto'>
        <div className='w-100 overflow-auto'>
          <div className='player-wrapper relative overflow-hidden pt-[56.25%] rounded'>
            <ReactPlayer
              url={'https://youtu.be/JrY-kaPEr3c'}
              controls={true}
              width='100%'
              height='100%'
...
// const CustomerStats = () => {
//   return(
//     <section className='mt-10 mb-20 pb-10 border-grayBorder border-b flex flex-row flex-wrap gap-y-10 container'>
//       <div className='w-1/2 flex flex-col items-center gap-3 md:w-1/4'>
//         <div className='text-4xl font-semibold'>4,958</div>
//         <div className='text-sm text-grayText'>Destinations</div>
//       </div>
//       <div className='w-1/2 flex flex-col items-center gap-3 md:w-1/4'>
//         <div className='text-4xl font-semibold'>2,869</div>
//         <div className='text-sm text-grayText'>Total Properties</div>
//       </div>
//       <div className='w-1/2 flex flex-col items-center gap-3 md:w-1/4'>
//         <div className='text-4xl font-semibold'>2M</div>
//         <div className='text-sm text-grayText'>Happy customers</div>
//       </div>
//       <div className='w-1/2 flex flex-col items-center gap-3 md:w-1/4'>
//         <div className='text-4xl font-semibold'>574,974</div>
//         <div className='text-sm text-grayText'>Our Volunteers</div>
//       </div>
//     </section>
//   )
// }
...
function ReviewCard ({ reviewTitle, reviewerName, reviewerAvatar, reviewerType, review }: ReviewCardType) {
  return(
    <div className='flex flex-col py-5 px-3 w-[300px] bg-white flex-none md:w-[400px] md:flex-auto h-[300px]' data-component='review-card'>
      <h4 className='text-base text-[#F15927] font-semibold'>{reviewTitle}</h4>
      <p className='text-sm mt-5'>{review}</p>
      <div className='border-t border-grayBorder pt-5 flex gap-3 mt-auto'>
        <Image src={reviewerAvatar} className='h-12 w-12 rounded-full object-cover' alt='reviewer-avatar'/>
        <div className='flex flex-col gap-1'>
          <div className='text-sm'>{reviewerName}</div>
          <div className='text-xs text-grayText'>{reviewerType}</div>
        </div>
      </div>
    </div>
  )
...
function ReviewBlock() {
  return(
    <section className='bg-grayBg my-10 py-10' data-component='review-block'>
      <div className='container'>
        <div className='flex flex-col gap-3 items-center justify-center'>
          <h2 className='text-2xl font-semibold'>Overheard from travelers</h2>
          <p className='text-sm text-grayText'>These popular destinations have a lot to offer</p>
        </div>
        {/* card slider */}
        <div className='mt-10 pb-5 flex flex-row gap-10 overflow-scroll scrollbarStyle md:overflow-hidden md:justify-between'>
          <ReviewCard 
            reviewTitle='3-Bed Furnished Apartment'
            reviewerName='Dr. Shahadat Hossain' 
            reviewerAvatar={sahadatAvatar} 
            reviewerType='Guest' 
            review='আলহামদুলিল্লাহ চমৎকার সার্ভিস পেয়েছি।যা যা উল্লেখিত ছিল, যেসকল সুবিধা পাওয়ার কথা ছিলো সকল কিছুই ফুলফিল ভাবে পেয়েছি।আমার অভিজ্ঞতা চমৎকার ছিলো।'
          />
          <ReviewCard 
            reviewTitle='MyPlace Apartments'
            reviewerName='Rabab Rana' 
            reviewerAvatar={rababAvatar}
            reviewerType='Host'
            review='STAYVERZ এর সাপোর্ট আমার খুবই ভালো লেগেছে। আমি যখনই কোনো প্রবলেম ফেইস করেছি, ওরা ইনস্ট্যান্টলি আমাকে সল্যুশন দিয়েছে। বাংলাদেশে হোস্টিং বিসনেস এর সার্থকতা অনেক এবং STAYVERZ এর মতো প্লাটফর্ম এর সম্ভাবনা আরো বাড়িয়ে দিচ্ছে।'
          />
          <ReviewCard 
            reviewTitle='Beautiful Furnished Apartment'
            reviewerName='Tawrat Jahan' 
            reviewerAvatar={tawratAvatar}
            reviewerType='Guest'
            review='STAYVERZ এর মাধ্যমে যতবারই বুকিং করেছি তাদের কাস্টমার সার্ভিস টিম ছিল চমৎকার। যে কোনো সমস্যার সমাধানে তারা অতি দ্রুত পদক্ষেপ নেন। STAYVERZ- এর সাথে আমার অভিজ্ঞতা বেশ ভালো, তাই আমি আমার আশেপাশের সবাইকে STAYVERZ-এর মাধ্যমে বুকিং করার জন্যই রেকমেন্ড করি'
          />
        </div>
      </div>
    </section>
...
const HappyBlock = () => {
  return(
    <section className='mt-10 container flex flex-col gap-10 md:flex-row md:gap-20 pb-10 border-b border-grayBorder'>
      {/* <div className='flex justify-center gap-10 md:w-1/4 md:justify-between items-center'>
        <div className='flex flex-col gap-3'>
          <div className='text-3xl font-semibold'>2000+</div>
          <div className='text-sm'>Happy People</div>
        </div>
        <div className='flex flex-col gap-3'>
          <div className='text-3xl font-semibold'>4.88</div>
          <div className='text-sm'>Overall rating</div>
        </div>
      </div> */}
      <div className='flex flex-col items-center gap-10 md:gap-0 md:flex-row md:justify-between w-full'>
        <Image src={airstraLogo} className='w-52 h-24 object-cover flex-none' alt='reviewer-avatar'/>
        <Image src={bLogo} className='h-24 w-24 object-cover flex-none' alt='reviewer-avatar'/>
        <Image src={bartaLogo} className='h-24 w-52 object-cover flex-none' alt='reviewer-avatar'/>
        <Image src={brandBazar} className='h-24 w-52 object-cover flex-none' alt='reviewer-avatar'/>
        <Image src={bsLogo} className='h-52 w-52 object-cover flex-none' alt='reviewer-avatar'/>
      </div>
    </section>
  )
}
