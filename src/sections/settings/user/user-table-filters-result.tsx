  ...
  return (
    <Stack spacing={1.5} {...other}>
      ...
      <Stack flexGrow={1} spacing={1} direction="row" flexWrap="wrap" alignItems="center">
        {filters.status !== 'all' && (
          <Block label="Status:">
            <Chip size="small" label={startCase(filters.status)} onDelete={handleRemoveStatus} />
          </Block>
        )}
        ...
        {!!filters.u_type && (
          <Block label="Role:">
            <Chip
              label={startCase(filters.u_type)}
              size="small"
        ...
        {!!filters.identity_verification_status && (
          <Block label="Verification: ">
            <Chip
              label={startCase(filters.identity_verification_status)}
              size="small"
