...
export default function UserTableRow({
  ...
  const { id, full_name, image, date_joined, role, status, email, phone_number } = row;
  ...
  return (
    <>
      <TableRow hover selected={selected}>
        ...
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{startCase(role)}</TableCell>
        ...
        <TableCell align="right" sx={{ px: 1, whiteSpace: 'nowrap' }}>
          <Tooltip title="Quick Edit" placement="top" arrow>
            <IconButton
              color="default"
              onClick={() => {
                router.push(`/settings/user/${id}/edit`);
              }}
            >
