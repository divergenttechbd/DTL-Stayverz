...
export default function UserTableFiltersResult({
  ...
  const shortLabel = shortDateLabel(filters.payment_date_after, filters.payment_date_before);
  ...
  return (
    <Stack spacing={1.5} {...other}>
      ...
      <Stack flexGrow={1} spacing={1} direction="row" flexWrap="wrap" alignItems="center">
        ...
        {filters.payment_date_after && filters.payment_date_before && (
          <Block label="Date:">
        ...
        {filters.host && (
          <Block label="Date:">
            <Chip size="small" label={filters.host.label} onDelete={handleRemoveHost} />
          </Block>
        )}
