    ...
    <>
      <TableRow hover selected={selected}>
        ...
        <TableCell align="right" sx={{ px: 1, whiteSpace: 'nowrap' }}>
          ...
          <Tooltip title={identity_verification_status === 'verified' ? 'Unverify User' : 'Verify User'} placement="top" arrow>
            <Button
              color={
                (identity_verification_status === 'verified' && 'error') ||
                ((identity_verification_status === 'not_verified' || identity_verification_status === 'pending')  && 'success') ||
                'primary'
              }
              onClick={onVerify}
            >
              {identity_verification_status === 'verified' && 'Unverify'}
              {(identity_verification_status === 'not_verified' || identity_verification_status === 'pending') && 'Verify'}
            </Button>
          </Tooltip>
