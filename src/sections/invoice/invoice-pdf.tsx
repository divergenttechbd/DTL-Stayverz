      ...
      <Page size="A4" style={styles.page}>
        <View style={[styles.gridContainer, styles.mb40]}>
          ...
          <View style={{ alignItems: 'flex-end', flexDirection: 'column' }}>
            ...
            <Text> {invoice.payment_data.invoice_no} </Text>
          </View>
        </View>
        ...
        <View style={[styles.gridContainer, styles.mb40]}>
          <View style={styles.col6}>
            ...
            <Text style={styles.body2}>{invoice.payment_data.host.full_name}</Text>
            <Text style={styles.body2}>{invoice.payment_data.host.full_name}</Text>
            <Text style={styles.body2}>{invoice.payment_data.host.full_name}</Text>
          </View>
        ...
        <View style={styles.table}>
          ...
          <View>
            {invoice.payment_data.items.map((item, index) => (
              <View style={styles.tableRow} key={item.id}>
                ...
                <View style={styles.tableCell_2}>
                  <Text style={styles.subtitle2}>{item.reservation_code}</Text>
                </View>
                ...
                <View style={styles.tableCell_3}>
                  <Text>{item.night_count}</Text>
                </View>

                <View style={[styles.tableCell_3, styles.alignRight]}>
                  <Text>{fCurrency(item.amount)}</Text>
                </View>
              </View>
            ))}
            <View style={[styles.tableRow, styles.noBorder]}>
              ...
              <View style={[styles.tableCell_3, styles.alignRight]}>
                <Text style={styles.h4}>{fCurrency(invoice.payment_data.total_amount)}</Text>
              </View>
            </View>
          </View>
        </View>
