...
const NearbyMobileSearch: FC<NearbyMobileSearch> = ({ handleModalClose, onSearchTypeClick, aciveSearchType }) => {
  ...
  const handleRadiusSelect = useCallback((selectedValue: number) => {
    ...
    setActiveTab(tabKeys.CHECK_IN_OUT)
  ...
  return (
    <div className={`w-full h-full flex flex-col justify-between gap-5`}>
      ...
      <div className={`h-full bg-white overflow-y-hidden rounded-tl-3xl border-t rounded-tr-3xl shadow-lg ${activeTab === tabKeys.DESTINATION ? 'slide-in-bottom block' : 'hidden'}`}>
      ...
      {/* SEARCH ITEMS */}
      <div className={`h-full overflow-y-auto px-5 ${activeTab !== tabKeys.DESTINATION ? 'block' : 'hidden'}`}>
        <div className='space-y-3'>
          {/* LOCATION */}
          <div className='space-y-3'>
            <div onClick={() => setActiveTab(tabKeys.DESTINATION)} className='px-3 py-4 rounded-2xl bg-white shadow-md flex justify-between items-center gap-2'>
          ...
          {/* RADIUS */}
          <div className='space-y-3'>
            {activeTab !== tabKeys.RADIUS ?
              <div onClick={() => setActiveTab(tabKeys.RADIUS)} className='px-3 py-4 rounded-2xl bg-white shadow-md flex justify-between items-center'>
          ...
          {/* DATE RANGE */}
          <div className='space-y-3'>
            {activeTab !== tabKeys.CHECK_IN_OUT ?
              <div onClick={() => setActiveTab(tabKeys.CHECK_IN_OUT)} className='px-3 py-4 rounded-2xl bg-white shadow-md flex justify-between items-center'>
          ...
          {/* GUEST COUNT */}
          <div className='space-y-3'>
            {activeTab !== tabKeys.GUESTS ?
              <div onClick={() => setActiveTab(tabKeys.GUESTS)} className='px-3 py-4 rounded-2xl bg-white shadow-md flex justify-between items-center'>
      ...
      {/* SEARCH ACTIONS */}
      <div className={`flex-1  ${activeTab !== tabKeys.DESTINATION ? 'block' : 'hidden'}`}>
